				...
				<nav class="sidebar-nav navcolor hav">
					<ul id="sidebarnav" class="navcolor" style="padding-top: 0px">
						<li class="sidebar-item"><a
							class="sidebar-link waves-effect navcolor sidebar-link " href="Tester_Dash.jsp"
						...
						<li class="sidebar-item"><a
							...
							<ul aria-expanded="false" class="collapse first-level navcolor">
								<li class="sidebar-item"><a
									...
									href="Tester.jsp" aria-expanded="false"><i
										class="mdi mdi-account"></i><span class="hide-menu fcol h">Tester</span></a></li>
